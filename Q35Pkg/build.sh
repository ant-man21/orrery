#!/usr/bin/env bash
# =============================================================================
# build.sh — EDK2 firmware builder for Q35Pkg (QEMU q35/OVMF, X64)
...
# ---------- platform (fixed — this script only builds Q35Pkg) -----------------
ARCH="X64"
TOOLCHAIN="GCC"
DSC="Q35Pkg/Q35Pkg.dsc"
